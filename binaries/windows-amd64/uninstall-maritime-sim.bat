...
echo ============================================================
echo   MARITIME SIM - Windows Uninstaller
echo ============================================================
echo.
...
set "CONFIG_DIR=C:\ProgramData\maritime-sim"

:: Remove binary
if exist "%INSTALL_DIR%\maritime-sim.exe" (
    del /q "%INSTALL_DIR%\maritime-sim.exe"
...
reg delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\MaritimeSim" /f >nul 2>&1
...
echo.
echo Maritime Sim has been uninstalled.
pause