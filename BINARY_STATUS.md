...
| Binary | Source Repo | Description | Status |
|--------|-------------|-------------|--------|
...
## Enhanced Simulators (5 binaries)

| Binary | Description | Status |
|--------|-------------|--------|
| boost-intercept | Boost-phase intercept (5 ICBM, 4 interceptors, 5 scenarios) | ✅ |
...
| launch-veh-sim | Launch vehicle simulation (9 vehicles, spherical gravity) | ✅ |

## External Simulators (3 binaries)

| Binary | Source | Platforms | Status |
|--------|--------|----------|--------|
| cyber-redteam-sim | cyber-redteam-sim | linux-amd64, linux-arm64, darwin-amd64, darwin-arm64, windows-amd64 | ✅ v0.2.0 |
| maritime-sim | maritime-sim | linux-amd64 | ✅ |
| space-war-sim | space-war-sim | linux-amd64 | ✅ |
...
| submarine-war-sim | Submarine warfare simulator | ✅ |
